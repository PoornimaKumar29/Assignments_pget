...
WHERE parent_object_id = OBJECT_ID('Courier');

ALTER TABLE Courier
DROP CONSTRAINT CK__Courier__Status__5535A963;


ALTER TABLE Courier
ADD CONSTRAINT CK_Courier_Status
CHECK (Status IN ('Delivered', 'Dispatched', 'Cancelled'));
